...
function increaseAndReset(reset = false) {
  clickCountText++;
...
document.addEventListener('DOMContentLoaded', function () {
  const btn12 = document.getElementById('btn-s12');
  if (btn12) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  darkBtn.addEventListener('click', function () {
    const tickIcon_ht_dark = document.getElementById('tickIcon-ht-dark');
    const featureItemDark = document.getElementById('featureItem-ht-dark');
    ...
    featureItemDark.classList.toggle('feature-active');
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  btnInvert.addEventListener('click', function () {
    ...
    const tickIcon_ic = document.getElementById('tickIcon-ic');
    const featureItem = document.getElementById('featureItem-ic');
...
document.addEventListener('DOMContentLoaded', function () {
  const uwWidgetCustomTrigger = document.getElementById('uw-widget-custom-trigger');
  if (!uwWidgetCustomTrigger) return;

  uwWidgetCustomTrigger.addEventListener('click', openMain);
});
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  speakButton.addEventListener('click', function () {
    const tickIcon_sp = document.getElementById('tickIcon_sp');
    const featureItem_sp = document.getElementById('featureItem_sp');
...
document.addEventListener("DOMContentLoaded", function () {
  // Run only after full DOM is ready
  const bigBtn = document.getElementById("btn-s9");
  const smallBtn = document.getElementById("btn-small-text");

  if (bigBtn && smallBtn) {
    handleFontSizes("btn-s9", "featureItem", "featureSteps", "tickIcon", true, "bt");
    handleFontSizes("btn-small-text", "featureItem-st", "featureSteps-st", "tickIcon-st", false, "st");
  } else {
    // Retry once if React rendered slightly later
    setTimeout(() => {
      if (document.getElementById("btn-s9") && document.getElementById("btn-small-text")) {
        handleFontSizes("btn-s9", "featureItem", "featureSteps", "tickIcon", true, "bt");
        handleFontSizes("btn-small-text", "featureItem-st", "featureSteps-st", "tickIcon-st", false, "st");
      }
    }, 500);
...
// in accessibility-weights.js (bottom)
window.increase = increaseAndReset;
