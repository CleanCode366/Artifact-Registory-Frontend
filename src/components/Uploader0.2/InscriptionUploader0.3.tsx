  ...
  return (
    <div className="min-h-screen text-white p-4">
      <div className="mx-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-secondary-dark text-center mb-2">Add Inscription</h1>
        </div>
        ...
        <div className={styles["add-inscription-container"]}>        {/* Photo Section */}
          <div className={`mb-6 p-5 ${styles["add-inscription-container-div"]}`}>
            {isCapturing ? (
              ...
              <div className="space-y-4" >
                ...
                <div className="flex gap-3">
                  <button
                    onClick={startCamera}
                    className="flex-1 px-4 py-3 bg-primary transition-all transform hover:scale-105 shadow-lg cursor-pointer text-white rounded-lg font-medium transition"
                  >
                    Take Photo
                  </button>
                  <button
          ...
          <div className={`space-y-6 p-5 ${styles["add-inscription-container-div"]}`}>
            <div>
              <label className="block text-sm text-secondary-dark font-medium mb-2">Title</label>
              <input
                type="text"
                ...
                className="w-full px-4 py-3 border border-gray-600 rounded-lg text-secondary-dark placeholder-gray-400"
              />
            </div>
            <div>
              <label className="block text-sm text-secondary-dark font-medium mb-2">Subject</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm text-secondary-dark font-medium mb-2">Description</label>
              <textarea
                ...
                className="w-full px-4 py-3 border border-gray-600 rounded-lg text-secondary-dark placeholder-gray-400 resize-none"
                rows={3}
              />
            </div>
            <div>
              <label className="block text-sm text-secondary-dark font-medium mb-2">Script Language (comma separated)</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-secondary-dark text-sm font-medium mb-2">Language (comma separated)</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm text-secondary-dark font-medium mb-2">Topic</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm text-secondary-dark font-medium mb-2">Script (comma separated)</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm text-secondary-dark font-medium mb-2">Type</label>
              <input
                type="text"
                value={formData.type || ""}
                onChange={e => handleInputChange("type", e.target.value)}
                placeholder="Stone, Leaf, Bark"
                className="w-full px-4 py-3 border border-gray-600 rounded-lg text-secondary-dark placeholder-gray-400"
              />
            </div>
            {/* Upload Button */}
