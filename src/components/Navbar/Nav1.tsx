                                    ...
                                    {authenticated ? (
                                        ...
                                        <div className="navbar-list" style={{ userSelect: "none", height: "100%" }}>
                                            <ul className="space-y-2 flex-row text-white items-center" style={{ display: "flex", flexDirection: "row", gap: "1rem", height: "100%", }}>
                                                <li className="header-links header-link-items cursor-pointer flex items-center" onClick={() => { scrollToSection(0) }} style={{ height: "100%" }}><a className="transition-colors flex items-center" style={{ height: "98%" }}>Home</a></li>
                                                <li className="header-links header-link-items cursor-pointer flex items-center" onClick={() => { scrollToSection(900) }} style={{ height: "100%" }}><a className=" transition-colors flex items-center" style={{ height: "98%" }}>Featured Discoveries</a></li>
                                                <li className="header-links header-link-items cursor-pointer flex items-center" onClick={() => { scrollToSection(1540) }} style={{ height: "100%" }}><a className=" transition-colors flex items-center" style={{ height: "98%" }}>How it works</a></li>
                                                <li className="header-links header-link-items cursor-pointer flex items-center" onClick={() => { scrollToSection(2140) }} style={{ height: "100%" }}><a className=" transition-colors flex items-center" style={{ height: "98%" }}>Recent Discoveries</a></li>
                                                <li className="header-links header-link-items cursor-pointer flex items-center" onClick={() => { scrollToSection(2940) }} style={{ height: "100%" }}><a className=" transition-colors flex items-center" style={{ height: "98%" }}>Community</a></li>
                                                <li className="header-links header-link-items cursor-pointer flex items-center" onClick={() => { scrollToSection(3570) }} style={{ height: "100%" }}><a className=" transition-colors flex items-center" style={{ height: "98%" }}>Get Started</a></li>
                                            </ul>
                                        </div>)}
