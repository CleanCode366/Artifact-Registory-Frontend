...
import placeholderImage1 from '@/assets/parallaxImages/banner.png';
        ...
        <div className="min-h-screen bg-primary-background">
            ...
            <div className="max-w-7xl mx-auto p-1 flex justify-between gap-30 sm:p-4 flex-col md:flex-row sm:justify-center sm:gap-10">
                        ...
                        <div className='flex justify-between items-start post-rating-like-share'>
                            ...
                            <div className="">
                                ...
                                <div className="flex items-center gap-2 text-[#000000] ">
                                    ...
                                    <span>{postToRender.description.geolocation && postToRender.description.geolocation.city}, {postToRender.description.geolocation && postToRender.description.geolocation.state || ''}</span>
                                </div>
                            </div>
                            ...
                            <div className="flex sm:flex-row sm:items-center sm:justify-between gap-4">
                                <div className="flex items-center gap-4">
                                    <span className="inline-flex items-center gap-x-1.5 px-3 py-2 rounded-lg font-medium bg-teal-500 hover:bg-teal-600 text-white">
                                        <Star />   {postToRender.rating && <StarRating rating={postToRender.rating} />}
                                    </span>
                                </div>
                                <div className="flex gap-3">
                                    <button
                                        onClick={() => setShowRatingModal(true)}
                                        className="px-6 py-2 cursor-pointer bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors font-medium"
                                    >
                                        Rate
                                    </button>
                                    <button
                                ...
                                <div className="flex items-start justify-between mb-3">
                                    <div className="flex-1">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                                            ...
                                            <div className="flex items-center gap-2 ">
                                                <MessageSquareWarning className="w-4 h-4" />                                            <span>Topic: {postToRender.topic && postToRender.topic}</span>
                                            </div>
                                        </div>
                ...
                <div className='card-styling p-4'>
                    ...
                    <div className="w-auto overflow-y-auto max-h-[780px] pr-2">
