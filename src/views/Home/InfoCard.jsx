        ...
        <div className="content">
          <div className="back">
            <div className="back-content">
              ...
              <strong className='text-secondary-dark'>{props.content.title}</strong>
              <p className='text-secondary-dark view-card-instruction-mob'>Tap to view more</p>

            </div>
          </div>
          <div className="front backdrop-blur-sm">
            <div className="img">
            ...
            <div className="front-content">
              <div className="description" style={{ height: "100%", width: "100%", textAlign: "center", display: "flex", justifyContent: "center", alignItems: "center" }}>
                <div className="title">
                  <p className="title" style={{ width: "100%" }}>
                    <strong className='text-secondary-dark  ' style={{ fontSize: "16px", display: "flex", justifyContent: "center", alignItems: "center", textAlign: "center" }}>
...
const StyledWrapper = styled.div`
  ...
  .content {
    ...
    box-shadow: rgba(10, 60, 255, 0.2) 0px 7px 29px 0px;
...
.back {
  ...
  .back::before {
    ...
    width: 460px;
    height: 160%;
    background: linear-gradient(180deg, transparent, #ff9966, #ff9966, #ff9966, #ff9966, transparent);
